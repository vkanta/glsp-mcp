...
wit_bindgen::generate!({
    world: "camera-front-simple",
    path: "../../../wit/adas-components",
});

// Type aliases for cleaner code
use exports::adas::sensor_data::camera_data;
use exports::adas::components::camera_control;
...
impl exports::adas::sensor_data::camera_data::Guest for Component {
    ...
    fn create_stream() -> exports::adas::sensor_data::camera_data::CameraStream {
        exports::adas::sensor_data::camera_data::CameraStream::new(CameraStreamState { id: 1 })
    }
}

impl exports::adas::sensor_data::camera_data::GuestCameraStream for CameraStreamState {
...
impl exports::adas::components::camera_control::Guest for Component {
